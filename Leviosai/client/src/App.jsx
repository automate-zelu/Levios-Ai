...
// ============================================================
// ── Twilio BYOT card — replaces the generic Twilio integration card ────────────
function TwilioByotCard() {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      setStatus(prev => ({ ...prev, phoneNumber: data.phoneNumber }));
      setResults(null); setSelected(null); setAreaCode("");
    } catch (e) { setError(e.message); }
...
function TwilioPage() {
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontSize: 22, fontWeight: 700, margin: 0 }}>Twilio</h2>
        <p style={{ color: COLORS.textMuted, fontSize: 13, margin: "4px 0 0" }}>Connect your Twilio account to enable AI calling and SMS outreach</p>
      </div>
      <TwilioByotCard />
    </div>
  );
...
export default function CatalystApp() {
  ...
  const navItems = [
    ...
    { section: "AI SDR Platform" },
    { name: "SDR Agent", icon: "🤖" },
    { name: "AI Calling", icon: "📞" },
